...
local function YBDNE_fake_script() -- Frame.LocalScript 
...
coroutine.wrap(YBDNE_fake_script)()
local function TXNXO_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(TXNXO_fake_script)()
local function UDTLGK_fake_script() -- wuhh.LocalScript 
...
coroutine.wrap(UDTLGK_fake_script)()
local function RAUMN_fake_script() -- bleh.LocalScript 
...
coroutine.wrap(RAUMN_fake_script)()
